//**************************************************************
//  cSPI class method definition - class for SPI control on raspberry
//**************************************************************
#include "cSPI.hpp"
using namespace std;
/**********************************************************
 ...
 * this function.
 * *********************************************************/
int cSpi::spiOpen(std::string devspi){
    int statusVal = -1;
 ...
 * "data".
 * ******************************************************************/
int cSpi::spiWriteRead( unsigned char *data, int length){
 ...
 * ***********************************************/
cSpi::cSpi(std::string devspi, unsigned char spiMode, unsigned int spiSpeed, unsigned char spibitsPerWord){
    this->mode = spiMode ;
